-- Migration: 043_fix_initial_due_date.sql
-- Description: Update trigger_initial_enrollment_due to correctly calculate the custom due date for new enrollments so they aren't instantly marked as overdue unless they enroll after the custom due day.
